...
entity_id = "E2201_MC_gov"
url = "http://www.medway.gov.uk/thecouncilanddemocracy/finances/councilspendingdata.aspx"
errors = 0
data = []
...
for link in links:
    url = link['href']
    if '.xlsx' or 'xls' in url:
        url = 'http://www.medway.gov.uk' + url
